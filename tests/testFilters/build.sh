...
v3c -target=wasm -heap-size=500m ${VIRGIL_PATH}/lib/util/Vector.v3 ${VIRGIL_PATH}/lib/util/Arrays.v3 ${VIRGIL_PATH}/lib/util/Ranges.v3 ../../src/Filters.v3 FiltersWasm.v3
